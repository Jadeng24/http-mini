...
class App extends Component {
  ...
  getPotentialBuyers() {
    ...
    axios.get( this.state.baseUrl + "/api/buyers")
        .then((response) => {
          // set state
          this.setState({
            buyers: response.data.buyersToDisplay
          })
        })
  ...
  filterByMake() {
    ...
    axios.get( this.state.baseUrl + "api/vehicles" + "?make=" + make)
          .then( (response)=> {
            this.setState({
              vehicles: this.state.vehiclesToDisplay
            })
          })
    // setState with response -> vehiclesToDisplay
  }
  ...
  addCar() {
    ...
    // axios (POST)
    axios.post(this.state.baseUrl + "/api/vehicles", newCar )// second part in post... BODY
        .then( (response) => {
  ...
  addBuyer() {
    ...
    //axios (POST)
    axios.post( this.state.baseUrl + "/api/buyers" + "?name=" + newBuyer.name)
          .then( (response)=> {
            this.setState({
      ...
      <div className=''>
        ...
        <div className='btn-container'>
          ...
          <select
            ...
            <option value="Chevrolet">Nissan</option>
